...
export default async function page() {
  await connectDB();
  const members = await getTeamMemberByType("smc");
  return (
    <div>
      <div className="w-full">
        <div className="flex  items-center  justify-between pb-2">
          <H2 className=" font-semibold">School Management Committee (SMC)</H2>
          <Button asChild>
            <Link
              href="/admin/teams/smc/new"
                      ...
                      <TableCell>
                        <div className="inline-flex gap-2">
                          <Link
                            ...
                            href={`/admin/teams/smc/${n._id}/edit`}
                          >
                            <PencilIcon size={16} />
                          </Link>
