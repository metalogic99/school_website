...
import { deleteTeacherMember } from "@/server/actions/teacher/teacher.action";

export default async function page() {
  await connectDB();
  const members = await Teacher.find().sort({ createdAt: -1 });
  return (
    <div>
      <div className="w-full">
        <div className="flex  items-center  justify-between pb-2">
          <H2 className=" font-semibold">Academic Staff</H2>
          <Button asChild>
            <Link
              href="/admin/teams/academic-staff/new"
                      ...
                      <TableCell>
                        <div className="inline-flex gap-2">
                          <Link
                            ...
                            href={`/admin/teams/academic-staff/${n._id}/edit`}
                          >
                            <PencilIcon size={16} />
                          </Link>
                          ...
                          <DeleteAlert
                            deleteAction={deleteTeacherMember}
