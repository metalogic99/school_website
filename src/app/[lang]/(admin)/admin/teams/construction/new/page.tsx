...
import { addNewConstructionMember } from "@/server/actions/construction/construction.action";
...
const page = () => {
  ...
  const onSubmit = async (data: TConstructionForm) => {
    try {
      ...
      const res = await addNewConstructionMember(formdata, imgData);
      toast({
