...
export default async function page() {
  await connectDB();
  const members = await getTeamMemberByType("bod");

  return (
    <div>
      <div className="w-full">
        <div className="flex  items-center  justify-between pb-2">
          <H2 className=" font-semibold">Board of Directors</H2>
          <Button asChild>
            <Link
              href="/admin/teams/board-of-directors/new"
                      ...
                      <TableCell className="text-right">
                        <div className="inline-flex gap-2">
                          <Link
                            ...
                            href={`/admin/teams/board-of-directors/${n._id}/edit`}
                          >
                            <PencilIcon size={16} />
                          </Link>
