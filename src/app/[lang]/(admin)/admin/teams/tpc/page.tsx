...
export default async function page() {
  await connectDB();
  const members = await getTeamMemberByType("tpc");
  return (
    <div>
      <div className="w-full">
        <div className="flex  items-center  justify-between pb-2">
          <H2 className=" font-semibold">Teacher-Parent Committee (TPC)</H2>
          <Button asChild>
            <Link
              href="/admin/teams/tpc/new"
                      ...
                      <TableCell>
                        <div className="inline-flex gap-2">
                          <Link
                            ...
                            href={`/admin/teams/tpc/${n._id}/edit`}
                          >
                            <PencilIcon size={16} />
                          </Link>
