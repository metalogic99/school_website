...
export default async function page({ params }: { params: { lang: string } }) {
  const { lang } = params;
  const title = lang === "en" ? "Uniform Donors" : "पोशाक दाताहरू";
  const donors = await Donors.find({ donation_type: "uniform" });
  ...
  return (
    <div>
      ...
      <section className=" mx-auto mt-8 flex  flex-col gap-8 py-10 ">
